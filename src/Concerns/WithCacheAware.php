...
trait WithCacheAware
{
    ...
    {
        throw_unless($this instanceof FinderInterface || class_uses_trait($this, WithCache::class), new RuntimeException(
            'You have to implement', [FinderInterface::class], 'or', [WithCache::class], 'trait to use cache aware functionality'
        ));
